...
<?php
$sql=mysqli_query($connect,"SELECT * FROM intro WHERE ID=$id");
          ...
          <div class="row">
            <div class="col-md-5">
              ...
              <div class="form-group" >
                ...
                <input type="" class="form-control " name="intro_text" value="<?php echo $query['Intro'];?>">
              </div>
              <!-- /.form-group -->
            </div>
            <!-- /.col -->
            <div class="col-md-5">
              ...
              <div class="form-group" >
                ...
                <textarea type="" class="form-control select2" name="caption"><?php echo $query['Caption'];?></textarea>
              </div>
              <!-- /.form-group -->
            </div>
            ...
            <div class="col-md-2" style="margin-top: 10%; ">
             <div class="form-group">
               ...
               <a href="dashboard.php?request=intro&amp;status=0" class="btn btn-danger" style="width: 80%;" name="" >Cancel</a>
               <input type="submit" class="btn btn-info" style="width: 80%; margin-top: 3%;" name="update" value="Update">
             </div>

        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-5">
              ...
              <!-- /.form-group -->
              <div class="form-group" >
                <label style="">Author</label>
                <input type="" class="form-control " name="author" value="<?php echo $query['Author'];?>">
              </div>
            ...
            <div class="col-md-5">
              ...
              <div class="form-group" >
                ...
                <textarea type="" class="form-control select2" name="caption"><?php echo $query['Content'];?></textarea>
              </div>
            </div>
            ...
            <div class="col-md-2" style="margin-top: 2%; ">
             <div class="form-group">
               ...
               <a href="dashboard.php?request=stories&amp;status=0" class="btn btn-danger" style="width: 80%;" name="" >Cancel</a>
               <input type="submit" class="btn btn-info" style="width: 80%; margin-top: 3%;" name="updatestory" value="Update">
             </div>

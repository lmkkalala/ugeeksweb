...
<?php
$sql=mysqli_query($connect,"SELECT * FROM team WHERE ID=$id");
          ...
          <div class="row">
            <div class="col-md-5">
              ...
              <div class="form-group" >
                ...
                <input type="" class="form-control " name="fname" value="<?php echo $query['First_Name'];?>">
              </div>
              <!-- /.form-group -->
              <div class="form-group" >
                <label style="">Skills</label>
                <input type="" class="form-control " name="skills" value="<?php echo $query['Skills'];?>">
              </div>
            </div>
            <!-- /.col -->
            <div class="col-md-5">
              ...
              <div class="form-group">
                ...
                <input type="" class="form-control select2" name="lname" value="<?php echo $query['Last_Name'];?>">
              </div>
              <!-- /.form-group -->
              <div class="form-group" >
            ...
            <div class="col-md-2" style="margin-top: 2%; ">
             <div class="form-group">
               ...
               <a href="dashboard.php?request=team&amp;status=0" class="btn btn-danger" style="width: 80%;" name="" >Cancel</a>
               <input type="submit" class="btn btn-info" style="width: 80%; margin-top: 3%;" name="updateteam" value="Update">
             </div>
